...
function ActivityChart({ sesiones }: { sesiones: any[] }) {
  ...
  const chartData = daysMap.map((dayLabel, index) => {
    // Filtrar sesiones por día de la semana y que sean de esta semana actual
    ...
    // Altura mínima del 12% para que no se vea "vacio"
...
export default async function Dashboard() {
  ...
  // --- CÁLCULO DE CALORÍAS ---
  // Fórmula simplificada: 5 METs * Peso * (minutos / 60)
  ...
  return (
    <div className="flex flex-col gap-6 pb-24 bg-background-light dark:bg-background-dark min-h-screen transition-colors duration-200">
